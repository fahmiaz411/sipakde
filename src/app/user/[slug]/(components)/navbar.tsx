...
import { FaUser, FaCog, FaSignOutAlt, FaHome, FaBell } from "react-icons/fa";
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav style={navbarStyle}>
      <div style={logoStyle} onClick={() => router.push("/user/dashboard")}>
        <img src="/sipakde_white.png" width={100} alt="" />
      </div>
