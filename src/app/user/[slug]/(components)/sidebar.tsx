...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    {
      label: "Dokumen",
      icon: <IoDocument size={20} color="white" style={{ margin: "0 10px" }} />,
      path: "/user/documents",
      subItems: [
        { label: "RAB", path: "?type=rab" },
        { label: "Take of Sheet", path: "?type=take-of-sheet" },
        { label: "TPK", path: "?type=tpk" },
        { label: "Berita Acara", path: "?type=berita-acara" },
      ],
    },
  ];
                  ...
                  <>
                    ...
                    >
                      {item.subItems.map((subItem, subIndex) => {
                        console.log(
                          [pathname + searchParams.toString()][0],
                        ...
                        return (
                          <li key={subIndex}>
                            <Link
                              ...
                              style={
                                `${pathname}?${searchParams.toString()}`.includes(
                                  item.path + subItem.path
                                )
